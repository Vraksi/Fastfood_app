...
namespace FastFoodAppServer.Models
{
    public partial class FastFoodAppServerContext : DbContext
    {
        public FastFoodAppServerContext()
        {
        }

        public FastFoodAppServerContext(DbContextOptions<FastFoodAppServerContext> options)
            : base(options)
        {
        }
